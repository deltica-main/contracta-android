...
internal data class AutoCaptureTraceConstantsSnapshot(
    ...
    val minOcrReadyScore: Double = 0.72,
    val allowSoftFailRelaxedCapture: Boolean = true,
    val softFailMinOcrReadyScore: Double = 0.90,
    val softFailReadyHitsRequired: Int = 3,
    val softFailReadyHitWindowMs: Long = 1500L,
    val relaxedNearReadyScoreMargin: Double = 0.03,
    val relaxedNearReadyStrikesRequired: Int = 3,
    val relaxedNearReadyStrikeWindowMs: Long = 1800L,
